...
* __Diseño del dispositivo de hardware.__
    ...
    * **Selección y consulta de las especificaciones de los componentes eléctronicos seleccionados (cápsula,tips).**
      ...
      En esta sección se aborda el tema de escoger los materiales para trabajar un proyecto con microcontroladores de libre acceso, más información en el siguiente vídeo.
